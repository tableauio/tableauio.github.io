...
> 使用示例请参考 [Excel wellknown 类型：Datetime →]({{< relref "../excel/wellknown-types/#datetime" >}})
...
> 使用示例请参考 [Excel wellknown 类型：Duration →]({{< relref "../excel/wellknown-types/#duration" >}})
...
> 使用示例请参考 [Excel wellknown 类型：Fraction →]({{< relref "../excel/wellknown-types/#fraction" >}})
...
> 使用示例请参考 [Excel wellknown 类型：Comparator →]({{< relref "../excel/wellknown-types/#comparator" >}})
...
> 使用示例请参考 [Excel wellknown 类型：Version →]({{< relref "../excel/wellknown-types/#version" >}})
