...
> 请参阅 [基础：日期时间 →]({{< relref "../basics/wellknown-types/#datetime" >}})
...
> 请参阅 [基础：持续时间 →]({{< relref "../basics/wellknown-types/#duration" >}})
...
> 请参阅 [基础：分数 →]({{< relref "../basics/wellknown-types/#fraction" >}})
...
> 请参阅 [基础：比较器 →]({{< relref "../basics/wellknown-types/#comparator" >}})
...
> 请参阅 [基础：版本 →]({{< relref "../basics/wellknown-types/#version" >}})
