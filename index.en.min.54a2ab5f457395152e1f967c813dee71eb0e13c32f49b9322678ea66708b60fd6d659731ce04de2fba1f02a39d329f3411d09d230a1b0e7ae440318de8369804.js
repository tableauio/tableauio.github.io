...
tableau/protobuf/wellknown.proto google/protobuf/timestamp.proto google/protobuf/duration.proto `}).add({id:329,href:"/docs/basics/wellknown-types/#datetime",title:"Wellknown types / Datetime ",description:"Wellknown types.",content:` For use cases, see Wellknown types: Datetime →
...
duration is based on google.protobuf.Duration, see JSON mapping. golang duration string form. golang ParseDuration. `}).add({id:331,href:"/docs/basics/wellknown-types/#fraction",title:"Wellknown types / Fraction ",description:"Wellknown types.",content:` For use cases, see Wellknown types: Fraction →
...
- N: floating-point numerator, e.g.: 0.01 is same to 1/100 `}).add({id:332,href:"/docs/basics/wellknown-types/#comparator",title:"Wellknown types / Comparator ",description:"Wellknown types.",content:` For use cases, see Wellknown types: Comparator →
A comparator holds a sign and a fraction value. Any number or fraction can compare with it.
Type Default Description comparator ==0 Format: &lt;Sign&gt;&lt;Fraction&gt;. e.g.: ==10, !=1/2, &lt;10%, &lt;=10‰, &gt;10%, &gt;=10‱ `}).add({id:333,href:"/docs/basics/wellknown-types/#version",title:"Wellknown types / Version ",description:"Wellknown types.",content:` For use cases, see Wellknown types: Version →
