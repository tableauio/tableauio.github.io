...
Scalar Enum Wellknown types Incell struct Incell list Incell map `}).add({id:164,href:"/zh/docs/excel/union/#单个-union-类型",title:"Union（联合体） / 单个 union 类型 ",description:"Excel union 使用指南。",content:` [!Note] Number 列是可选的，用于自定义字段编号及对应的枚举值编号。省略时从 1 开始自动递增。
...
hello_world.proto `}).add({id:166,href:"/zh/docs/excel/union/#指定-type-列",title:"Union（联合体） / 指定 Type 列 ",description:"Excel union 使用指南。",content:` 默认情况下，每个 union 的 oneof 字段是一个以 Name 列指定名称的 message 类型。 现在，你可以添加 Type 列并指定自定义的 oneof 字段类型：
...
hello_world.proto `}).add({id:167,href:"/zh/docs/excel/union/#复杂-union-类型",title:"Union（联合体） / 复杂 union 类型 ",description:"Excel union 使用指南。",content:` 例如，HelloWorld.xlsx 中的两个 worksheet Target 和 TaskConf：
...
hello_world.proto TaskConf.json `}).add({id:168,href:"/zh/docs/excel/list/#水平列表horizontal-list",title:"List（列表） / 水平列表（Horizontal list） ",description:"列表使用指南。",content:` [!IMPORTANT] 水平 list 的列名中，列表元素名必须带有从 1 开始的数字后缀。
例如：Item1ID、Item2ID、Item3ID（struct list，元素名：Item）；ID1、ID2、ID3（scalar list，元素名：ID）。
水平列表语法概览：
List 元素类型 语法示例 scalar []uint32 enum []enum&lt;.FruitType&gt; struct [Item]uint32 predefined struct [.Item]uint32 incell struct []{uint32 ID, string Num}Item incell predefined struct []{.Item} `}).add({id:169,href:"/zh/docs/excel/list/#水平标量列表",title:"List（列表） / 水平标量列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:170,href:"/zh/docs/excel/list/#水平枚举列表",title:"List（列表） / 水平枚举列表 ",description:"列表使用指南。",content:` common.proto 中预定义的枚举类型 FruitType：
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:171,href:"/zh/docs/excel/list/#水平结构体列表",title:"List（列表） / 水平结构体列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:172,href:"/zh/docs/excel/list/#水平预定义结构体列表",title:"List（列表） / 水平预定义结构体列表 ",description:"列表使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:173,href:"/zh/docs/excel/list/#水平单元格内结构体列表",title:"List（列表） / 水平单元格内结构体列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:174,href:"/zh/docs/excel/list/#水平单元格内预定义结构体列表",title:"List（列表） / 水平单元格内预定义结构体列表 ",description:"列表使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:175,href:"/zh/docs/excel/list/#垂直列表vertical-list",title:"List（列表） / 垂直列表（Vertical list） ",description:"列表使用指南。",content:` 垂直列表语法概览：
List 元素类型 语法示例 scalar []uint32 enum []enum&lt;.FruitType&gt; struct [Item]uint32 predefined struct [.Item]int32 incell struct []{int32 ID,int32 Num}Item incell predefined struct []{.Item} `}).add({id:176,href:"/zh/docs/excel/list/#垂直标量列表",title:"List（列表） / 垂直标量列表 ",description:"列表使用指南。",content:` [!NOTE] 定义方式与 Incell scalar list 相同，但如果提供了多行数据，会聚合多行。
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID []uint32 ID 1,2,3 1,2 1 生成结果：
hello_world.proto ItemConf.json `}).add({id:177,href:"/zh/docs/excel/list/#垂直枚举列表",title:"List（列表） / 垂直枚举列表 ",description:"列表使用指南。",content:` [!NOTE] 定义方式与 Incell enum list 相同，但如果提供了多行数据，会聚合多行。
...
hello_world.proto ItemConf.json `}).add({id:178,href:"/zh/docs/excel/list/#垂直结构体列表",title:"List（列表） / 垂直结构体列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:179,href:"/zh/docs/excel/list/#垂直预定义结构体列表",title:"List（列表） / 垂直预定义结构体列表 ",description:"列表使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID Num [.Item]int32 int32 Item&rsquo;s ID Item&rsquo;s num 1 100 2 200 3 300 生成结果：
hello_world.proto ItemConf.json `}).add({id:180,href:"/zh/docs/excel/list/#垂直单元格内结构体列表",title:"List（列表） / 垂直单元格内结构体列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Item []{int32 ID,int32 Num}Item Item list 1:100 2:200,3:300 生成结果：
hello_world.proto ItemConf.json `}).add({id:181,href:"/zh/docs/excel/list/#垂直单元格内预定义结构体列表",title:"List（列表） / 垂直单元格内预定义结构体列表 ",description:"列表使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Item []{.Item} Item&rsquo;s info 1:100 2:200,3:300 生成结果：
hello_world.proto ItemConf.json `}).add({id:182,href:"/zh/docs/excel/list/#单元格内列表incell-list",title:"List（列表） / 单元格内列表（Incell list） ",description:"列表使用指南。",content:` 单元格内列表语法概览：
List 元素类型 语法示例 scalar []int32 enum []enum&lt;.FruitType&gt; incell struct []{int32 ID,int32 Num}Item incell predefined struct []{.Item} `}).add({id:183,href:"/zh/docs/excel/list/#单元格内标量列表",title:"List（列表） / 单元格内标量列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
生成结果：
hello_world.proto ItemConf.json `}).add({id:184,href:"/zh/docs/excel/list/#单元格内枚举列表",title:"List（列表） / 单元格内枚举列表 ",description:"列表使用指南。",content:` common.proto 中预定义的枚举类型 FruitType：
HelloWorld.xlsx 中的 worksheet ItemConf：
...
生成结果：
hello_world.proto ItemConf.json `}).add({id:185,href:"/zh/docs/excel/list/#单元格内结构体列表",title:"List（列表） / 单元格内结构体列表 ",description:"列表使用指南。",content:` [!NOTE] 更高级的 incell 数据解析，请参考 高级 predefined incell struct。
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Item []{int32 ID,int32 Num}Item Item&rsquo;s info 1:100,2:200,3:300 生成结果：
hello_world.proto ItemConf.json `}).add({id:186,href:"/zh/docs/excel/list/#单元格内预定义结构体列表",title:"List（列表） / 单元格内预定义结构体列表 ",description:"列表使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Item []{.Item} Item&rsquo;s info 1:100,2:200,3:300 生成结果：
hello_world.proto ItemConf.json `}).add({id:187,href:"/zh/docs/excel/list/#水平列表大小",title:"List（列表） / 水平列表大小 ",description:"列表使用指南。",content:`
`}).add({id:188,href:"/zh/docs/excel/list/#动态大小",title:"List（列表） / 动态大小 ",description:"列表使用指南。",content:` 默认情况下，所有 list 都是动态大小类型。List 元素应连续存在，否则如果中间存在空元素会报错。
`}).add({id:189,href:"/zh/docs/excel/list/#固定大小",title:"List（列表） / 固定大小 ",description:"列表使用指南。",content:` 隐式固定大小 # List 大小由名称行中最大存在的 list 元素数量自动确定。
...
hello_world.proto ItemConf.json `}).add({id:190,href:"/zh/docs/excel/list/#高级特性",title:"List（列表） / 高级特性 ",description:"列表使用指南。",content:`
`}).add({id:191,href:"/zh/docs/excel/list/#水平跳列列表",title:"List（列表） / 水平跳列列表 ",description:"列表使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:192,href:"/zh/docs/excel/map/#水平映射horizontal-map",title:"Map（映射） / 水平映射（Horizontal map） ",description:"映射使用指南。",content:` [!IMPORTANT] 水平映射的列名中，map 元素名必须带有从 1 开始的数字后缀。
例如：Item1ID、Item1Name、Item2ID、Item2Name（struct map，元素名：Item）。
水平 map 有以下几种：
水平 scalar map，map value 类型为 scalar。例如：map&lt;int32, int32&gt;。 水平 struct map，map value 类型为 struct。例如：map&lt;int32, Item&gt;。 水平 predefined-struct map，map value 类型为 predefined struct。例如：map&lt;int32, .Item&gt;。 `}).add({id:193,href:"/zh/docs/excel/map/#水平标量映射",title:"Map（映射） / 水平标量映射 ",description:"映射使用指南。",content:` 无需单独支持，请使用 map&lt;int32, Item&gt; 代替。
`}).add({id:194,href:"/zh/docs/excel/map/#水平结构体映射",title:"Map（映射） / 水平结构体映射 ",description:"映射使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:195,href:"/zh/docs/excel/map/#水平预定义结构体映射",title:"Map（映射） / 水平预定义结构体映射 ",description:"映射使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:196,href:"/zh/docs/excel/map/#垂直映射vertical-map",title:"Map（映射） / 垂直映射（Vertical map） ",description:"映射使用指南。",content:` 垂直映射有以下几种：
垂直 scalar map，map value 类型为 scalar。例如：map&lt;int32, int32&gt;。 垂直 struct map，map value 类型为 struct。例如：map&lt;int32, Item&gt;。 垂直 predefined-struct map，map value 类型为 predefined struct。例如：map&lt;int32, .Item&gt;。 `}).add({id:197,href:"/zh/docs/excel/map/#垂直标量映射",title:"Map（映射） / 垂直标量映射 ",description:"映射使用指南。",content:` 无需单独支持，请使用 map&lt;int32, Item&gt; 代替。
`}).add({id:198,href:"/zh/docs/excel/map/#垂直结构体映射",title:"Map（映射） / 垂直结构体映射 ",description:"映射使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:199,href:"/zh/docs/excel/map/#垂直预定义结构体映射",title:"Map（映射） / 垂直预定义结构体映射 ",description:"映射使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID Num map&lt;int32, .Item&gt; int32 Item&rsquo;s ID Item&rsquo;s num 1 100 2 200 3 300 生成结果：
hello_world.proto ItemConf.json `}).add({id:200,href:"/zh/docs/excel/map/#单元格内映射incell-map",title:"Map（映射） / 单元格内映射（Incell map） ",description:"映射使用指南。",content:` 单元格内映射有以下几种：
Incell scalar map，map value 类型为 scalar。例如：map&lt;int32, int32&gt;。 Incell struct map，map value 类型为 struct。例如：map&lt;int32, Item&gt;。 `}).add({id:201,href:"/zh/docs/excel/map/#单元格内标量映射",title:"Map（映射） / 单元格内标量映射 ",description:"映射使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
生成结果：
hello_world.proto ItemConf.json `}).add({id:202,href:"/zh/docs/excel/map/#单元格内枚举映射",title:"Map（映射） / 单元格内枚举映射 ",description:"映射使用指南。",content:` 对于 incell map，key 和 value 都可以是枚举类型。
...
hello_world.proto ItemConf.json `}).add({id:203,href:"/zh/docs/excel/map/#空键映射empty-key-map",title:"Map（映射） / 空键映射（Empty key map） ",description:"映射使用指南。",content:` 如果 map key 未配置，则视为 map key 类型的默认值。默认值参见 Scalar types。
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:204,href:"/zh/docs/excel/map/#枚举键映射enum-key-map",title:"Map（映射） / 枚举键映射（Enum key map） ",description:"映射使用指南。",content:` 根据 protobuf 文档对 map key type 的限制：
...
hello_world.proto ItemConf.json `}).add({id:205,href:"/zh/docs/excel/map/#水平映射大小",title:"Map（映射） / 水平映射大小 ",description:"映射使用指南。",content:`
`}).add({id:206,href:"/zh/docs/excel/map/#动态大小",title:"Map（映射） / 动态大小 ",description:"映射使用指南。",content:` 默认情况下，所有 map 都是动态大小类型。Map 条目应连续存在，否则如果中间存在空条目会报错。
`}).add({id:207,href:"/zh/docs/excel/map/#固定大小",title:"Map（映射） / 固定大小 ",description:"映射使用指南。",content:` 隐式固定大小 # Map 大小由名称行中最大存在的 map 条目数量自动确定。
...
hello_world.proto ItemConf.json `}).add({id:208,href:"/zh/docs/excel/map/#高级特性",title:"Map（映射） / 高级特性 ",description:"映射使用指南。",content:`
`}).add({id:209,href:"/zh/docs/excel/map/#水平跳列映射",title:"Map（映射） / 水平跳列映射 ",description:"映射使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:210,href:"/zh/docs/excel/keyedlist/#语法",title:"KeyedList（键控列表） / 语法 ",description:"Excel keyed list 使用指南。",content:` Keyed list 与普通 list 相同，区别在于 ColumnType（第一个字段类型）被尖括号 &lt;&gt; 包围，并作为 map key 处理。
语法：[ElemType]&lt;ColumnType&gt;
`}).add({id:211,href:"/zh/docs/excel/keyedlist/#水平-list",title:"KeyedList（键控列表） / 水平 list ",description:"Excel keyed list 使用指南。",content:` TODO&hellip;
`}).add({id:212,href:"/zh/docs/excel/keyedlist/#垂直-keyedlist",title:"KeyedList（键控列表） / 垂直 KeyedList ",description:"Excel keyed list 使用指南。",content:`
`}).add({id:213,href:"/zh/docs/excel/keyedlist/#垂直-scalar-keyedlist",title:"KeyedList（键控列表） / 垂直 scalar KeyedList ",description:"Excel keyed list 使用指南。",content:` [!NOTE] 定义方式与 Incell scalar KeyedList 相同，但如果提供了多行数据，会进行聚合。
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID []&lt;uint32&gt; ID 1,2,3 4,5 6 生成结果：
hello_world.proto ItemConf.json `}).add({id:214,href:"/zh/docs/excel/keyedlist/#垂直-enum-keyedlist",title:"KeyedList（键控列表） / 垂直 enum KeyedList ",description:"Excel keyed list 使用指南。",content:` [!NOTE] 定义方式与 Incell enum KeyedList 相同，但如果提供了多行数据，会进行聚合。
common.proto 中预定义的枚举类型 FruitType：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Type []&lt;enum&lt;.FruitType&gt;&gt; Type Apple,Orange FRUIT_TYPE_BANANA 0 生成结果：
hello_world.proto ItemConf.json `}).add({id:215,href:"/zh/docs/excel/keyedlist/#垂直-struct-keyedlist",title:"KeyedList（键控列表） / 垂直 struct KeyedList ",description:"Excel keyed list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:216,href:"/zh/docs/excel/keyedlist/#incell-keyedlist",title:"KeyedList（键控列表） / Incell KeyedList ",description:"Excel keyed list 使用指南。",content:`
`}).add({id:217,href:"/zh/docs/excel/keyedlist/#incell-scalar-keyedlist",title:"KeyedList（键控列表） / Incell scalar KeyedList ",description:"Excel keyed list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID []&lt;uint32&gt; ID list 1,2,3 生成结果：
hello_world.proto ItemConf.json `}).add({id:218,href:"/zh/docs/excel/keyedlist/#incell-enum-keyedlist",title:"KeyedList（键控列表） / Incell enum KeyedList ",description:"Excel keyed list 使用指南。",content:` common.proto 中预定义的枚举类型 FruitType：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Param []enum&lt;.FruitType&gt; Param list 1,FRUIT_TYPE_ORANGE,Banana Param 列的类型为 incell list []enum&lt;.FruitType&gt;，list 元素为预定义枚举类型 FruitType。
生成结果：
hello_world.proto ItemConf.json `}).add({id:219,href:"/zh/docs/excel/wellknown-types/#datetime日期时间",title:"Wellknown types（知名类型） / Datetime（日期时间） ",description:"Wellknown types 使用指南。",content:`
`}).add({id:220,href:"/zh/docs/excel/wellknown-types/#datetime日期时间-1",title:"Wellknown types（知名类型） / Datetime（日期时间） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Datetime
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:221,href:"/zh/docs/excel/wellknown-types/#date日期",title:"Wellknown types（知名类型） / Date（日期） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Datetime
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:222,href:"/zh/docs/excel/wellknown-types/#time时间",title:"Wellknown types（知名类型） / Time（时间） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Datetime
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:223,href:"/zh/docs/excel/wellknown-types/#duration时长",title:"Wellknown types（知名类型） / Duration（时长） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Duration
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:224,href:"/zh/docs/excel/wellknown-types/#fraction分数",title:"Wellknown types（知名类型） / Fraction（分数） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Fraction
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:225,href:"/zh/docs/excel/wellknown-types/#comparator比较器",title:"Wellknown types（知名类型） / Comparator（比较器） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Comparator
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:226,href:"/zh/docs/excel/wellknown-types/#version版本号",title:"Wellknown types（知名类型） / Version（版本号） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Version
...
hello_world.proto ItemConf.json `}).add({id:227,href:"/zh/docs/excel/struct-in-struct/#struct-in-struct",title:"Struct 嵌套 Struct / Struct in struct ",description:"Excel struct in struct 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:228,href:"/zh/docs/excel/struct-in-struct/#predefined-struct-in-struct",title:"Struct 嵌套 Struct / Predefined-struct in struct ",description:"Excel struct in struct 使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU RewardID RewardItemID RewardItemNum {Reward}int32 {.Item}int32 int32 Reward&rsquo;s ID Item&rsquo;s ID Item&rsquo;s num 1 1 10 生成结果：
hello_world.proto ItemConf.json `}).add({id:229,href:"/zh/docs/excel/struct-in-struct/#incell-struct-in-struct",title:"Struct 嵌套 Struct / Incell-struct in struct ",description:"Excel struct in struct 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:230,href:"/zh/docs/excel/struct-in-list/#垂直-list-中的嵌套",title:"List 嵌套 Struct / 垂直 list 中的嵌套 ",description:"Excel struct in list 使用指南。",content:`
`}).add({id:231,href:"/zh/docs/excel/struct-in-list/#垂直-list-中的-struct",title:"List 嵌套 Struct / 垂直 list 中的 struct ",description:"Excel struct in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:232,href:"/zh/docs/excel/struct-in-list/#垂直-list-中的-incell-struct",title:"List 嵌套 Struct / 垂直 list 中的 incell struct ",description:"Excel struct in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:233,href:"/zh/docs/excel/struct-in-list/#水平-list-的第一个字段",title:"List 嵌套 Struct / 水平 list 的第一个字段 ",description:"Excel struct in list 使用指南。",content:`
`}).add({id:234,href:"/zh/docs/excel/struct-in-list/#水平-list-中的-struct",title:"List 嵌套 Struct / 水平 list 中的 struct ",description:"Excel struct in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:235,href:"/zh/docs/excel/struct-in-list/#水平-list-中的-predefined-struct",title:"List 嵌套 Struct / 水平 list 中的 predefined struct ",description:"Excel struct in list 使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Reward1ItemID Reward1ItemNum Reward1Name Reward2ItemID Reward2ItemNum Reward2Name [Reward]{.Item}int32 int32 string int32 int32 string Item1&rsquo;s ID Item1&rsquo;s num Reward&rsquo;s name Item1&rsquo;s ID Item1&rsquo;s num Reward&rsquo;s name 1 10 Lotto 10 100 Super Lotto 生成结果：
hello_world.proto ItemConf.json `}).add({id:236,href:"/zh/docs/excel/struct-in-list/#水平-list-中的-incell-struct",title:"List 嵌套 Struct / 水平 list 中的 incell struct ",description:"Excel struct in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
ItemConf.json `}).add({id:237,href:"/zh/docs/excel/struct-in-map/#垂直-map-中的嵌套",title:"Map 嵌套 Struct / 垂直 map 中的嵌套 ",description:"Excel struct in map 使用指南。",content:`
`}).add({id:238,href:"/zh/docs/excel/struct-in-map/#垂直-map-中的-struct",title:"Map 嵌套 Struct / 垂直 map 中的 struct ",description:"Excel struct in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:239,href:"/zh/docs/excel/struct-in-map/#垂直-map-中的-predefined-struct",title:"Map 嵌套 Struct / 垂直 map 中的 predefined struct ",description:"Excel struct in map 使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID ItemID ItemNum map&lt;int32, Reward&gt; {.Item}int32 int32 Reward&rsquo;s ID Item&rsquo;s ID Item&rsquo;s Num 1 1 10 2 2 20 3 生成结果：
hello_world.proto ItemConf.json `}).add({id:240,href:"/zh/docs/excel/struct-in-map/#垂直-map-中的-incell-struct",title:"Map 嵌套 Struct / 垂直 map 中的 incell struct ",description:"Excel struct in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:241,href:"/zh/docs/excel/list-in-list/#垂直-list-中的嵌套",title:"List 嵌套 List / 垂直 list 中的嵌套 ",description:"Excel list in list 使用指南。",content:`
`}).add({id:242,href:"/zh/docs/excel/list-in-list/#垂直-list-中的水平-list",title:"List 嵌套 List / 垂直 list 中的水平 list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:243,href:"/zh/docs/excel/list-in-list/#垂直-keyed-list-中的垂直-list",title:"List 嵌套 List / 垂直 keyed-list 中的垂直 list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:244,href:"/zh/docs/excel/list-in-list/#垂直-keyed-list-中的垂直-keyed-list",title:"List 嵌套 List / 垂直 keyed-list 中的垂直 keyed-list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:245,href:"/zh/docs/excel/list-in-list/#垂直-keyed-list-中的-incell-list",title:"List 嵌套 List / 垂直 keyed-list 中的 incell list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:246,href:"/zh/docs/excel/list-in-list/#垂直-keyed-list-中的-incell-keyed-list",title:"List 嵌套 List / 垂直 keyed-list 中的 incell keyed-list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
生成结果：
hello_world.proto ItemConf.json `}).add({id:247,href:"/zh/docs/excel/list-in-list/#水平-list-中的嵌套",title:"List 嵌套 List / 水平 list 中的嵌套 ",description:"Excel list in list 使用指南。",content:`
`}).add({id:248,href:"/zh/docs/excel/list-in-list/#水平-list-中的水平-list",title:"List 嵌套 List / 水平 list 中的水平 list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:249,href:"/zh/docs/excel/list-in-list/#水平-list-中的-predefined-struct-list",title:"List 嵌套 List / 水平 list 中的 predefined struct list ",description:"Excel list in list 使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Reward1Item1ID Reward1Item1Num Reward1Item2ID Reward1Item2Num Reward1Name Reward2Item1ID Reward2Item1Num Reward2Name [Reward][.Item]int32 int32 int32 int32 string int32 int32 string Item1&rsquo;s ID Item1&rsquo;s num Item2&rsquo;s ID Item2&rsquo;s num Reward&rsquo;s name Item1&rsquo;s ID Item1&rsquo;s num Reward&rsquo;s name 1 10 2 20 Lotto 10 100 Super Lotto 生成结果：
hello_world.proto ItemConf.json `}).add({id:250,href:"/zh/docs/excel/list-in-list/#水平-list-中的-incell-list",title:"List 嵌套 List / 水平 list 中的 incell list ",description:"Excel list in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:251,href:"/zh/docs/excel/list-in-map/#垂直-map-中的嵌套",title:"Map 嵌套 List / 垂直 map 中的嵌套 ",description:"Excel list in map 使用指南。",content:`
`}).add({id:252,href:"/zh/docs/excel/list-in-map/#垂直-map-中的水平-list",title:"Map 嵌套 List / 垂直 map 中的水平 list ",description:"Excel list in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:253,href:"/zh/docs/excel/list-in-map/#垂直-map-中的垂直-list",title:"Map 嵌套 List / 垂直 map 中的垂直 list ",description:"Excel list in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:254,href:"/zh/docs/excel/list-in-map/#垂直-map-中的-incell-list",title:"Map 嵌套 List / 垂直 map 中的 incell list ",description:"Excel list in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:255,href:"/zh/docs/excel/list-in-map/#垂直-map-中的-incell-struct-list",title:"Map 嵌套 List / 垂直 map 中的 incell struct list ",description:"Excel list in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:256,href:"/zh/docs/excel/list-in-map/#水平-map-中的嵌套",title:"Map 嵌套 List / 水平 map 中的嵌套 ",description:"Excel list in map 使用指南。",content:`
`}).add({id:257,href:"/zh/docs/excel/list-in-map/#水平-map-中的水平-list",title:"Map 嵌套 List / 水平 map 中的水平 list ",description:"Excel list in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:258,href:"/zh/docs/excel/list-in-map/#水平-map-中的-incell-list",title:"Map 嵌套 List / 水平 map 中的 incell list ",description:"Excel list in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
生成结果：
hello_world.proto ItemConf.json `}).add({id:259,href:"/zh/docs/excel/map-in-list/#垂直-list-中的嵌套",title:"List 嵌套 Map / 垂直 list 中的嵌套 ",description:"Excel map in list 使用指南。",content:`
`}).add({id:260,href:"/zh/docs/excel/map-in-list/#垂直-list-中的水平-map",title:"List 嵌套 Map / 垂直 list 中的水平 map ",description:"Excel map in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:261,href:"/zh/docs/excel/map-in-list/#垂直-keyed-list-中的垂直-map",title:"List 嵌套 Map / 垂直 keyed-list 中的垂直 map ",description:"Excel map in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:262,href:"/zh/docs/excel/map-in-list/#垂直-list-中的-incell-map",title:"List 嵌套 Map / 垂直 list 中的 incell map ",description:"Excel map in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:263,href:"/zh/docs/excel/map-in-list/#水平-list-的第一个字段",title:"List 嵌套 Map / 水平 list 的第一个字段 ",description:"Excel map in list 使用指南。",content:`
`}).add({id:264,href:"/zh/docs/excel/map-in-list/#水平-list-中的水平-map",title:"List 嵌套 Map / 水平 list 中的水平 map ",description:"Excel map in list 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:265,href:"/zh/docs/excel/map-in-list/#水平-list-中的-predefined-struct-map",title:"List 嵌套 Map / 水平 list 中的 predefined struct map ",description:"Excel map in list 使用指南。",content:` common.proto 中预定义的 Item：
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU Reward1Item1ID Reward1Item1Num Reward1Item2ID Reward1Item2Num Reward1Name Reward2Item1ID Reward2Item1Num Reward2Name [Reward]map&lt;int32, .Item&gt; int32 int32 int32 string int32 int32 string Item1&rsquo;s ID Item1&rsquo;s num Item2&rsquo;s ID Item2&rsquo;s num Reward&rsquo;s name Item1&rsquo;s ID Item1&rsquo;s num Reward&rsquo;s name 1 10 2 20 Lotto 10 100 Super Lotto 生成结果：
hello_world.proto ItemConf.json `}).add({id:266,href:"/zh/docs/excel/map-in-map/#垂直-map-中的嵌套",title:"Map 嵌套 Map / 垂直 map 中的嵌套 ",description:"Excel map in map 使用指南。",content:`
`}).add({id:267,href:"/zh/docs/excel/map-in-map/#垂直-map-中的水平-map",title:"Map 嵌套 Map / 垂直 map 中的水平 map ",description:"Excel map in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:268,href:"/zh/docs/excel/map-in-map/#垂直-map-中的垂直-map",title:"Map 嵌套 Map / 垂直 map 中的垂直 map ",description:"Excel map in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:269,href:"/zh/docs/excel/map-in-map/#垂直-map-中的-incell-map",title:"Map 嵌套 Map / 垂直 map 中的 incell map ",description:"Excel map in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:270,href:"/zh/docs/excel/map-in-map/#水平-map-中的嵌套",title:"Map 嵌套 Map / 水平 map 中的嵌套 ",description:"Excel map in map 使用指南。",content:`
`}).add({id:271,href:"/zh/docs/excel/map-in-map/#水平-map-中的水平-map",title:"Map 嵌套 Map / 水平 map 中的水平 map ",description:"Excel map in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:272,href:"/zh/docs/excel/map-in-map/#水平-map-中的-incell-map",title:"Map 嵌套 Map / 水平 map 中的 incell map ",description:"Excel map in map 使用指南。",content:` HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:273,href:"/zh/docs/excel/infinite-nesting/#概述",title:"无限嵌套 / 概述 ",description:"Excel 无限嵌套使用指南。",content:` 现在，水平/垂直 list 元素的第一个字段可以是任意类型，包括 struct、list 和 map。
...
`}).add({id:274,href:"/zh/docs/excel/infinite-nesting/#嵌套命名",title:"无限嵌套 / 嵌套命名 ",description:"Excel 无限嵌套使用指南。",content:` common.proto 中的预定义类型：
...
hello_world.proto loader_conf.json `}).add({id:275,href:"/zh/docs/excel/field-property/#概览",title:"Field property（字段属性） / 概览 ",description:"Tableau field property 使用指南。",content:` 选项 类型 说明 unique bool 检查字段唯一性。
...
- PATCH_REPLACE - PATCH_MERGE sep string 字段级分隔符。 subsep string 字段级子分隔符。 cross int32 指定具有基数的复合类型（如 list 和 map）跨越的节点/单元格/字段数量。 pattern string 指定 scalar、list 元素和 map value 的模式。 `}).add({id:276,href:"/zh/docs/excel/field-property/#选项-unique",title:"Field property（字段属性） / 选项 unique ",description:"Tableau field property 使用指南。",content:` 选项 unique 可在 field property 中指定为 true 或 false，用于检查 list/map 元素中任意 scalar 字段的唯一性。
如果显式设置 unique 为 true，当出现重复 key 时 tableau 会报错。 如果显式设置 unique 为 false，则不进行检查。 `}).add({id:277,href:"/zh/docs/excel/field-property/#map或-keyedlist的-key",title:"Field property（字段属性） / Map（或 KeyedList）的 key ",description:"Tableau field property 使用指南。",content:` Tableau 会自动推断 map（或 KeyedList）key 的 unique 是否为 true。
规则是：如果 map 的 value 类型（或 KeyedList 元素类型）没有相同布局（垂直/水平）的子 map/list 字段，则 key 必须唯一。
因此大多数情况下不需要显式配置。
`}).add({id:278,href:"/zh/docs/excel/field-property/#通用-scalar-字段",title:"Field property（字段属性） / 通用 scalar 字段 ",description:"Tableau field property 使用指南。",content:` 如果将通用 scalar 字段的属性 unique 指定为 true，则 tableau 会检查该字段在 map 或 list 中的唯一性。
`}).add({id:279,href:"/zh/docs/excel/field-property/#选项-range",title:"Field property（字段属性） / 选项 range ",description:"Tableau field property 使用指南。",content:` [!WARNING] 当单元格数据为空（未填写）时，此检查将被跳过。若需对空单元格也强制执行检查，请将选项 present 设置为 true。
选项 range 的格式为：&quot;left,right&quot;（左右均为闭区间）。
range 的不同含义：
数字：值范围，例如：&quot;1,10&quot;、&quot;1,~&quot;、&quot;~,10&quot;。 字符串：UTF-8 码点数量。 list：list 的长度。 map：map 的长度。 `}).add({id:280,href:"/zh/docs/excel/field-property/#选项-refer",title:"Field property（字段属性） / 选项 refer ",description:"Tableau field property 使用指南。",content:` 选项 refer 类似于 SQL 中的外键（FOREIGN KEY）约束，用于防止破坏表之间关联的操作。但 tableau 的 refer 可以引用任意 sheet 的列（不限于 map key 列），并且支持多个 refer（逗号分隔）。它用于确保该字段的值至少在其他某个 sheet 的列值空间（即 message 的字段值空间）中存在。
格式：&quot;SheetName(SheetAlias).ColumnName[,SheetName(SheetAlias).ColumnName]...&quot;。
示例：
map&lt;uint32, Reward&gt;|{refer:&quot;ItemConf.ID&quot;}：无别名的单 refer，sheet 名即为生成的 protobuf message 名。 map&lt;uint32, Reward&gt;|{refer:&quot;ItemConf.ID,EquipConf.ID&quot;}：无别名的多 refer，sheet 别名即为生成的 protobuf message 名。 map&lt;uint32, Reward&gt;|{refer:&quot;Sheet1(ItemConf).ID&quot;}：有别名的单 refer，sheet 别名即为生成的 protobuf message 名。 `}).add({id:281,href:"/zh/docs/excel/field-property/#选项-sequence",title:"Field property（字段属性） / 选项 sequence ",description:"Tableau field property 使用指南。",content:` 选项 sequence 用于确保该字段的值是一个从指定值开始的序列，可用于任意字段，包括嵌套 list/map 中的字段。
示例：
map&lt;uint32, Item&gt;|{sequence:1}：该 map key 必须遵循从值 1 开始的序列规则。 int32|{sequence:1}：父级 list/map 的元素必须遵循从值 1 开始的序列规则。 `}).add({id:282,href:"/zh/docs/excel/field-property/#选项-default",title:"Field property（字段属性） / 选项 default ",description:"Tableau field property 使用指南。",content:` 如果设置了选项 default，则当单元格为空时使用该值作为默认值。
`}).add({id:283,href:"/zh/docs/excel/field-property/#选项-fixed",title:"Field property（字段属性） / 选项 fixed ",description:"Tableau field property 使用指南。",content:` 如果将选项 fixed 设置为 true，则自动检测水平 list/map 的固定大小。
示例：
List: 隐式固定大小 Map: 隐式固定大小 `}).add({id:284,href:"/zh/docs/excel/field-property/#选项-size",title:"Field property（字段属性） / 选项 size ",description:"Tableau field property 使用指南。",content:` 选项 size 用于指定水平 list/map 的固定大小。
示例：
List: 显式固定大小 Map: 显式固定大小 `}).add({id:285,href:"/zh/docs/excel/field-property/#选项-form",title:"Field property（字段属性） / 选项 form ",description:"Tableau field property 使用指南。",content:` 选项 form 用于指定 incell struct 的单元格数据格式。
可指定两种格式：
FORM_TEXT：protobuf text format。 FORM_JSON：protobuf JSON format。 详细示例请参考 高级 predefined incell struct。
`}).add({id:286,href:"/zh/docs/excel/field-property/#选项-json_name",title:"Field property（字段属性） / 选项 json_name ",description:"Tableau field property 使用指南。",content:` 默认情况下，JSON 名称由字段的 proto 名称转换为 camelCase 得到。现在可以通过 json_name prop 选项显式指定。
例如，HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID Rarity_1 SpecialEffect_2 map&lt;int32, Item&gt; int32|{json_name:&ldquo;rarity_1&rdquo;} int32|{json_name:&ldquo;specialEffect_2&rdquo;} Item&rsquo;s ID Item&rsquo;s rarity. Item&rsquo;s special effect. 1 10 101 2 20 102 3 30 103 `}).add({id:287,href:"/zh/docs/excel/field-property/#选项-present",title:"Field property（字段属性） / 选项 present ",description:"Tableau field property 使用指南。",content:` 如果将选项 present 设置为 true，则单元格数据不能为空，必须显式填写，否则会报错。
`}).add({id:288,href:"/zh/docs/excel/field-property/#选项-optional",title:"Field property（字段属性） / 选项 optional ",description:"Tableau field property 使用指南。",content:` 指定该字段是否为可选（字段名可缺失）。
如果设置为 true，则：
表格格式（Excel/CSV）：字段的列可以缺失。 文档格式（XML/YAML）：字段名可以缺失。 `}).add({id:289,href:"/zh/docs/excel/field-property/#选项-patch",title:"Field property（字段属性） / 选项 patch ",description:"Tableau field property 使用指南。",content:` 参见 选项 Patch 中的字段级 patch。
`}).add({id:290,href:"/zh/docs/excel/field-property/#选项-sep",title:"Field property（字段属性） / 选项 sep ",description:"Tableau field property 使用指南。",content:` 字段级分隔符，用于分隔：
incell list 元素（scalar 或 struct）。 incell map 元素 如果未设置，将使用 metasheet 中的sheet 级 sep。
`}).add({id:291,href:"/zh/docs/excel/field-property/#选项-subsep",title:"Field property（字段属性） / 选项 subsep ",description:"Tableau field property 使用指南。",content:` 字段级子分隔符，用于分隔：
每个 incell map 元素的键值对。 每个 incell struct list 元素的结构体字段。 如果未设置，将使用 metasheet 中的sheet 级 subsep。
`}).add({id:292,href:"/zh/docs/excel/field-property/#选项-cross",title:"Field property（字段属性） / 选项 cross ",description:"Tableau field property 使用指南。",content:` 指定具有基数的复合类型（如 list 和 map）跨越的节点/单元格/字段数量。
`}).add({id:293,href:"/zh/docs/excel/field-property/#union-list-字段",title:"Field property（字段属性） / union list 字段 ",description:"Tableau field property 使用指南。",content:` TODO: 示例待补充。
指定 list 将跨越并占用的 union 字段数量（每个字段对应一个 list 元素）。这也会将该 list 字段的布局从 incell 改为水平。
值为 0 表示是 incell list。 值 &gt; 0 表示是占用 N 个字段的水平 list。 值 &lt; 0 表示是占用所有后续字段的水平 list。 `}).add({id:294,href:"/zh/docs/excel/field-property/#选项-pattern",title:"Field property（字段属性） / 选项 pattern ",description:"Tableau field property 使用指南。",content:` 指定 scalar 字段、list 元素和 map value 的模式。
`}).add({id:295,href:"/zh/docs/excel/field-property/#wellknown-version-字段",title:"Field property（字段属性） / Wellknown version 字段 ",description:"Tableau field property 使用指南。",content:` [!NOTE] 使用案例请参考 Wellknown types: Version
指定当前单元格的点分十进制模式。每个十进制数的范围从 0 到模式对应部分的最大值（MAX）。
默认模式：255.255.255。
`}).add({id:296,href:"/zh/docs/excel/metasheet/#概述",title:"Metasheet（元表） / 概述 ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 以下选项可在 metasheet @TABLEAU 中指定，用于影响对应 worksheet 的布局、功能、loader 等。
...
示例：
- OrderedMap:cpp,Index:cpp go // ordered map 仅支持 cpp，index 支持 cpp 和 go - OrderedMap:cpp // ordered map 仅支持 cpp，index 支持所有语言 `}).add({id:297,href:"/zh/docs/excel/metasheet/#空-tableau",title:"Metasheet（元表） / 空 @TABLEAU ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 如果 metasheet @TABLEAU 为空，则同一 workbook 中的所有其他 worksheet 都会被处理。
`}).add({id:298,href:"/zh/docs/excel/metasheet/#简单示例",title:"Metasheet（元表） / 简单示例 ",description:"Excel metasheet @TABLEAU 使用指南。",content:` HelloWorld.xlsx 中有一个 worksheet Sheet1，我们希望将其重命名为 ItemConf，定义自定义分隔符为 |，并生成 ordered map 访问器。
因此，HelloWorld.xlsx 中的 metasheet @TABLEAU 应配置如下：
HelloWorld.xlsx&nbsp; Sheet1 @TABLEAU ID Name map&lt;uint32, Item&gt; string Item&rsquo;s ID Item&rsquo;s Name 1 Apple 2 Orange 3 Banana Sheet Alias Sep OrderedMap Sheet1 ItemConf | true `}).add({id:299,href:"/zh/docs/excel/metasheet/#workbook-alias",title:"Metasheet（元表） / Workbook Alias ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 生成的 proto 文件名是输入文件名的 snake_case 形式。例如，如果 workbook 名为 HelloWorld.xlsx，则生成的 proto 文件名为 hello_world.proto。如果希望手动指定生成的 proto 文件名，可以使用 Alias 选项。在此场景中，# 表示 workbook 名称。
HelloWorld.xlsx 中的 worksheet ItemConf：
...
custom_conf.proto `}).add({id:300,href:"/zh/docs/excel/metasheet/#选项-mode",title:"Metasheet（元表） / 选项 Mode ",description:"Excel metasheet @TABLEAU 使用指南。",content:` Sheet mode 定义了 tableauc（protogen）解析 sheet 的方式：数据或类型。
可用模式：
MODE_DEFAULT：默认模式，定义 sheet 的数据结构。 MODE_ENUM_TYPE：在一个 sheet 中定义单个枚举类型，参见 示例。 MODE_ENUM_TYPE_MULTI：在一个 sheet 中定义多个枚举类型，参见 示例。 MODE_STRUCT_TYPE：在一个 sheet 中定义单个 struct 类型，参见 示例。 MODE_STRUCT_TYPE_MULTI：在一个 sheet 中定义多个 struct 类型，参见 示例。 MODE_UNION_TYPE：在一个 sheet 中定义单个 union 类型，参见 示例。 MODE_UNION_TYPE_MULTI：在一个 sheet 中定义多个 union 类型，参见 示例。 `}).add({id:301,href:"/zh/docs/excel/metasheet/#选项-transpose",title:"Metasheet（元表） / 选项 Transpose ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 在线性代数中，矩阵的转置是将矩阵沿对角线翻转的操作。类似地，sheet（二维矩阵）的转置意味着将行与列互换。
...
hello_world.proto HeroConf.json `}).add({id:302,href:"/zh/docs/excel/metasheet/#选项-merger",title:"Metasheet（元表） / 选项 Merger ",description:"Excel metasheet @TABLEAU 使用指南。",content:` Merger 选项用于将多个具有相同 schema 的 sheet（逗号分隔）合并为一个。
每个元素可以是：
...
`}).add({id:303,href:"/zh/docs/excel/metasheet/#合并多个-workbook",title:"Metasheet（元表） / 合并多个 workbook ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 例如，有三个 workbook，每个都包含一个具有相同 schema 的 worksheet ZoneConf：
...
merger_main.proto ZoneConf.json `}).add({id:304,href:"/zh/docs/excel/metasheet/#合并同一-workbook-中的多个-sheet",title:"Metasheet（元表） / 合并同一 workbook 中的多个 sheet ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 例如，同一 workbook Merger.xlsx 中有三个具有相同 schema 的 worksheet：
...
生成结果：
merger_same.proto ZoneConf.json `}).add({id:305,href:"/zh/docs/excel/metasheet/#选项-scatter",title:"Metasheet（元表） / 选项 Scatter ",description:"Excel metasheet @TABLEAU 使用指南。",content:` Scatter 选项用于将多个具有相同 schema 的 sheet（逗号分隔）分别转换为不同的配置文件。
每个元素可以是：
仅 workbook 文件路径或 Glob 路径（相对于当前 workbook）：&lt;Workbook&gt;，此时 sheet 名称与当前 sheet 相同。 workbook 文件路径（相对于当前 workbook）加 worksheet 名称：&lt;Workbook&gt;#&lt;Worksheet&gt;。 [!NOTE] Glob 模式通常不应匹配主 workbook。如果匹配，tableauc 会自动排除它。
...
Scatter1_ZoneConf.json Scatter2_ZoneConf.json Scatter3_ZoneConf.json `}).add({id:306,href:"/zh/docs/excel/metasheet/#选项-orderedmap",title:"Metasheet（元表） / 选项 OrderedMap ",description:"Excel metasheet @TABLEAU 使用指南。",content:` [!IMPORTANT] 仅适用于每个层级 message 的第一个 map 字段。
如果将 OrderedMap 设置为 true，则 tableau loader 插件将生成 ordered map API：
C++: OrderedMap API Go: OrderedMap API `}).add({id:307,href:"/zh/docs/excel/metasheet/#选项-index",title:"Metasheet（元表） / 选项 Index ",description:"Excel metasheet @TABLEAU 使用指南。",content:` Index 选项可用于生成 index 访问器。 有两种 index：
...
示例：
(ID,Name)：未设置 index 名，由父 struct 类型名决定。 (ID,Name)@AwardItem (ID,Name)&lt;ID&gt;：结果数组按 ID 排序。 (ID,Type)&lt;Type,Priority&gt;@Item：结果数组按 Type 和 Priority 排序。 ID@Item, (ID,Name)@AwardItem：一个单列 index 和一个多列 index。 `}).add({id:310,href:"/zh/docs/excel/metasheet/#选项-orderedindex",title:"Metasheet（元表） / 选项 OrderedIndex ",description:"Excel metasheet @TABLEAU 使用指南。",content:` OrderedIndex 选项可用于生成 ordered index 访问器。 有两种 ordered index：
...
ID&lt;Name&gt;@Item：对 ID 列建立单列 ordered index，结果数组按 Name 排序。 HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID Name Desc map&lt;int32, Item&gt; string string Item&rsquo;s ID Item&rsquo;s name Item&rsquo;s desc 1 Apple A kind of delicious fruit. 2 Orange A kind of sour fruit. 3 Banana A kind of calorie-rich fruit. Sheet OrderedIndex ItemConf ID@Item `}).add({id:312,href:"/zh/docs/excel/metasheet/#多列-orderedindex",title:"Metasheet（元表） / 多列 OrderedIndex ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 格式：(Column1,Column2,...)&lt;ColumnX,ColumnY,...&gt;@IndexName。
...
(ID,Type)&lt;Type&gt;@Shop：对 (ID, Type) 列建立多列 ordered index，结果数组按 Type 排序。 (ID,Type)&lt;Type,ID&gt;@SpecialShop：对 (ID, Type) 列建立多列 ordered index，结果数组按 Type 然后 ID 排序。 HelloWorld.xlsx&nbsp; ShopConf @TABLEAU ID Type Desc [Shop]int32 int32 string Shop&rsquo;s ID Shop&rsquo;s type Shop&rsquo;s desc 1 1 Shoes shop. 2 1 T-Shirt shop. 3 2 Fruite shop. Sheet OrderedIndex ShopConf (ID,Type)@Shop, (ID,Type)&lt;Type,ID&gt;@SpecialShop `}).add({id:313,href:"/zh/docs/excel/metasheet/#选项-patch",title:"Metasheet（元表） / 选项 Patch ",description:"Excel metasheet @TABLEAU 使用指南。",content:`

`}).add({id:314,href:"/zh/docs/excel/metasheet/#选项-sep",title:"Metasheet（元表） / 选项 Sep ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 工作表的分隔符，用于分隔：
incell list 元素（scalar 或 struct）。 incell map 元素。 如果未设置，将使用 Tableauc 配置 中的全局级别分隔符（默认：,）。
`}).add({id:315,href:"/zh/docs/excel/metasheet/#选项-subsep",title:"Metasheet（元表） / 选项 Subsep ",description:"Excel metasheet @TABLEAU 使用指南。",content:` 工作表的子分隔符，用于分隔：
每个 incell map 元素的键值对。 每个 incell struct list 元素的结构体字段。 如果未设置，将使用 Tableauc 配置 中的全局级别子分隔符（默认：:）。
`}).add({id:316,href:"/zh/docs/basics/",title:"基础",description:"Tableau 基础知识。",content:""}).add({id:317,href:"/zh/docs/basics/concepts/#术语",title:"核心概念 / 术语 ",description:"Tableau 核心概念。",content:`
