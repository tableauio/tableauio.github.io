...
生成结果：
hello_world.proto ItemConf.json `}).add({id:187,href:"/zh/docs/excel/list/#incell-struct-list",title:"List（列表） / Incell struct list ",description:"Excel list 使用指南。",content:` [!NOTE] 更高级的 incell 数据解析，请参考 高级 predefined incell struct。
HelloWorld.xlsx 中的 worksheet ItemConf：
...
`}).add({id:216,href:"/zh/docs/excel/keyedlist/#纵向-scalar-keyedlist",title:"KeyedList（键控列表） / 纵向 scalar KeyedList ",description:"Excel keyed list 使用指南。",content:` [!NOTE] 定义方式与 Incell scalar KeyedList 相同，但如果提供了多行数据，会进行聚合。
HelloWorld.xlsx 中的 worksheet ItemConf：
HelloWorld.xlsx&nbsp; ItemConf @TABLEAU ID []&lt;uint32&gt; ID 1,2,3 4,5 6 生成结果：
hello_world.proto ItemConf.json `}).add({id:217,href:"/zh/docs/excel/keyedlist/#纵向-enum-keyedlist",title:"KeyedList（键控列表） / 纵向 enum KeyedList ",description:"Excel keyed list 使用指南。",content:` [!NOTE] 定义方式与 Incell enum KeyedList 相同，但如果提供了多行数据，会进行聚合。
common.proto 中预定义的枚举类型 FruitType：
HelloWorld.xlsx 中的 worksheet ItemConf：
...
`}).add({id:223,href:"/zh/docs/excel/wellknown-types/#datetime日期时间-1",title:"Wellknown types（知名类型） / Datetime（日期时间） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Datetime
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:224,href:"/zh/docs/excel/wellknown-types/#date日期",title:"Wellknown types（知名类型） / Date（日期） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Datetime
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:225,href:"/zh/docs/excel/wellknown-types/#time时间",title:"Wellknown types（知名类型） / Time（时间） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Datetime
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:226,href:"/zh/docs/excel/wellknown-types/#duration时长",title:"Wellknown types（知名类型） / Duration（时长） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Duration
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:227,href:"/zh/docs/excel/wellknown-types/#fraction分数",title:"Wellknown types（知名类型） / Fraction（分数） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Fraction
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:228,href:"/zh/docs/excel/wellknown-types/#comparator比较器",title:"Wellknown types（知名类型） / Comparator（比较器） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Comparator
HelloWorld.xlsx 中的 worksheet ItemConf：
...
hello_world.proto ItemConf.json `}).add({id:229,href:"/zh/docs/excel/wellknown-types/#version版本号",title:"Wellknown types（知名类型） / Version（版本号） ",description:"Wellknown types 使用指南。",content:` [!NOTE] 参考 Basics: Version
...
`}).add({id:298,href:"/zh/docs/excel/field-property/#wellknown-version-字段",title:"Field property（字段属性） / Wellknown version 字段 ",description:"Tableau field property 使用指南。",content:` [!NOTE] 使用案例请参考 Wellknown types: Version
...
Scatter1_ZoneConf.json Scatter2_ZoneConf.json Scatter3_ZoneConf.json `}).add({id:309,href:"/zh/docs/excel/metasheet/#选项-orderedmap",title:"Metasheet（元表） / 选项 OrderedMap ",description:"Excel metasheet @TABLEAU 使用指南。",content:` [!IMPORTANT] 仅适用于每个层级 message 的第一个 map 字段。
...
tableau/protobuf/wellknown.proto google/protobuf/timestamp.proto google/protobuf/duration.proto `}).add({id:340,href:"/zh/docs/basics/wellknown-types/#datetime日期时间",title:"Wellknown types（知名类型） / Datetime（日期时间） ",description:"Wellknown 类型。",content:` [!NOTE] 使用示例请参考 Wellknown 类型：Datetime 。
...
datetime 和 date 基于 google.protobuf.Timestamp，参考 JSON 映射。 time 基于 google.protobuf.Duration，参考 JSON 映射。 RFC 3339: 互联网日期和时间戳 `}).add({id:341,href:"/zh/docs/basics/wellknown-types/#duration时长",title:"Wellknown types（知名类型） / Duration（时长） ",description:"Wellknown 类型。",content:` [!NOTE] 使用示例请参考 Wellknown 类型：Duration 。
...
duration 基于 google.protobuf.Duration，参考 JSON 映射。 golang duration 字符串格式。 golang ParseDuration。 `}).add({id:342,href:"/zh/docs/basics/wellknown-types/#fraction分数",title:"Wellknown types（知名类型） / Fraction（分数） ",description:"Wellknown 类型。",content:` [!NOTE] 使用示例请参考 Wellknown 类型：Fraction 。
...
- N/D：简单分数，例如：3/4
- N：仅分子，例如：3 等同于 3/1
- N：浮点分子，例如：0.01 等同于 1/100 `}).add({id:343,href:"/zh/docs/basics/wellknown-types/#comparator比较器",title:"Wellknown types（知名类型） / Comparator（比较器） ",description:"Wellknown 类型。",content:` [!NOTE] 使用示例请参考 Wellknown 类型：Comparator 。
comparator 包含一个 sign（符号）和一个分数 value（值），任意数字或分数均可与之比较。
类型 默认值 说明 comparator ==0 格式：&lt;Sign&gt;&lt;Fraction&gt;。
例如：==10、!=1/2、&lt;10%、&lt;=10‰、&gt;10%、&gt;=10‱ `}).add({id:344,href:"/zh/docs/basics/wellknown-types/#version版本号",title:"Wellknown types（知名类型） / Version（版本号） ",description:"Wellknown 类型。",content:` [!NOTE] 使用示例请参考 Wellknown 类型：Version 。
